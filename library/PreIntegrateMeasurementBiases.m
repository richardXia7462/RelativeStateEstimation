function [del_a,del_v,del_p,Cov,Jacobian,CovG,CovA,correlation]=PreIntegrateMeasurementBiases(Acc,Gyro,t,imuParameter,bg,ba)
    ...
    for i=1:n-1
        ...
        JPa = JPa+JVa*dt-0.5*del_a*dt^2;
        JPg = JPg+JVg*dt-0.5*del_a*GetCrossMat(acc)*JRg*dt^2;
        JVa = JVa-del_a*dt;
        JVg = JVg-del_a*GetCrossMat(acc)*JRg*dt;
