function [x_est, p_cov] = extendedPreintegratedNonlinearOptimizationVisBA(IMUF, IMUL, imuParameter, imuParameterL, markF, Tcb, camParameters, bPixel, obsPixelPH, rPixel, x0, p0)
% x0 = iniEst;
        ...
        for j = 1:nFace
            if bPixel(i, j)==1
                ...
                for k = 1:nTagPerFace
                    ...
                    hTemp((k-1)*2+1:k*2,1:3) = -Jac*Tcb(1:3,1:3)*Rlf*x_crossMat(markF(:,(j-1)*nTagPerFace+k));
